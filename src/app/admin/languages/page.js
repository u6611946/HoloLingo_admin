const langs = [
  ...
  /* NEW BURMESE */
  { code:'MM', label:'Burmese',      flagBg:'#3a2d12', flagColor:'#ffd166', users:178,  words:442,  border:'rgba(255,209,102,.25)', live:true  },
];

const userColors = ['#00e5ff','#a78bfa','#4ade80','#ffd166'];
    ...
    <div style={{padding:'24px'}}>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:'20px'}}>
        <div>
          ...
          <div style={{color:'#3a5060',fontSize:'11px',marginTop:'2px'}}>6 languages configured · 5 live</div>
        </div>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'14px'}}>
        {langs.map((l,i)=>(
          ...
          >
            ...
            >
              ...
              >
                <div style={{color:'#3a5060',fontSize:'9px'}}>
                  Users studying
                </div>
            ...
            <div style={{display:'flex',gap:'6px'}}>
              ...
              <button
                style={{
                  ...
                  border:'1px solid rgba(255,76,76,.25)',
                  borderRadius:'7px',
                  padding:'5px 12px',
                  color:'#ff6b6b',
                  fontSize:'11px',
        ...
        >
          ...
          >
            142 words added · need 1,000 to launch
          </div>
          ...
          >
            <span style={{color:'#3a5060',fontSize:'10px'}}>
              14% complete
            </span>

            <span style={{color:'#ffc800',fontSize:'10px'}}>
              858 more needed
            </span>
          </div>
